...
public @interface MFix {

    /**
     * Specifies an arbitrary point for the insertion of the fix.
     */
    At at() default @At(point = InsertionPoint.HEAD);
     ...
     * Use @At instead of this.
     */
    @Deprecated boolean insertOnExit() default false;
     ...
     * It is preferable to use @At instead of this.
     * <p/>
    ...
    /**
     * Allows the replacement of a local variable with the value that the fix method returns.
     * The variable type is taken from the return type of the fix method.
     */
