...
import net.tclproject.mysteriumlib.asm.core.MFixInserterFactory.OnExit;
 ...
 * Terms used: <p/>
 * MFix - the execution of your static code from minecraft's, forge's, or another mod's code
 *  <p/>
 ...
 *  <p/>
 * MFix Method - your static method that gets called from other's code
 *  <p/>
 * MFix Class (Class with fixes) - the class, inside which your fix method/s is located.
 */
public class MASMFix implements Cloneable, Comparable<MASMFix> {
    ...
    public MFixInserterFactory injectorFactory = ON_ENTER_FACTORY;

    /**An instance of a factory that makes fix inserters that insert fixes before/after a specific anchor..*/
    public static final MFixInserterFactory BY_ANCHOR_FACTORY = MFixInserterFactory.ByAnchor.INSTANCE;
    /**An instance of a factory that makes fix inserters that insert fixes on the start of the method.*/
    public static final MFixInserterFactory ON_ENTER_FACTORY = MFixInserterFactory.OnEnter.INSTANCE;
    /**An instance of a factory that makes fix inserters that insert fixes on the end of the method.*/
    public static final MFixInserterFactory ON_EXIT_FACTORY = OnExit.INSTANCE;
    ...
    public InsertionPoint getAnchorPoint() {
        return InsertionPoint.valueOf((String) anchor.get("point"));
    }
    ...
    /**Returns if the method is the target of this MASMFix.*/
    ...
    /**Getter for classWithFixes.*/
    public String getClassWithFixes() {
        return classWithFixes;
    }
    ...
    public MFixInserterFactory getInjectorFactory() {
        return injectorFactory;
    }

    /**Returns if a fix method is stored inside this MASMFix (in other words, if fixMethodName != null && classWithFixes != null).*/
    ...
    public void createMethod(FixInserterClassVisitor classVisitor) {
        ...
        if (methodVisitor instanceof MFixInserter) { // If the method is, indeed, to be created
        	MFixInserter inserter = (MFixInserter) methodVisitor;
            inserter.visitCode();
     ...
     * @param inserter the MFixInserter that has called this method.
     * */
    public void insertFix(MFixInserter inserter) {
        ...
        if (hasFixMethod()) {
            ...
            if (localVarID > -1) {
                inserter.visitVarInsn(OpCodesUtil.getVarStoreOpcode(fixMethodReturnType), localVarID);
            }
     ...
     * */
    public void insertLoad(MFixInserter inserter, Type parameterType, int variableIndex) {
        int opcode;
     ...
     * @param inserter Inserter that is inserting this fix.
     * */
    public void insertSuperCall(MFixInserter inserter, MetaReader.MethodReference method) {
        int variableIndex = 0;
     ...
     * */
    public void insertPushDefaultReturnValue(MFixInserter inserter, Type targetMethodReturnType) {
     ...
     * @param targetMethodReturnType the return type of the target method.
     * */
    public void insertReturn(MFixInserter inserter, Type targetMethodReturnType) {
     ...
     * */
    public void insertInvokeStatic(MFixInserter inserter, int indexOfReturnArgument, String name, String descriptor) {
    ...
    @Override
    public int compareTo(MASMFix fix) {
     ...
     * @return a new builder for a new MASMFix object.
     * */
    public static MBuilder newBuilder() {
        return new MASMFix().new MBuilder();
    }

    /**MASMFix with additional setters.*/
    public class MBuilder extends MASMFix {

        private MBuilder() {

        }

        public MBuilder setAnchorForInject(HashMap<String,Object> anchor) {
            MASMFix.this.anchor = anchor;
            setInjectorFactory(MASMFix.BY_ANCHOR_FACTORY);
            return this;
        }
         ...
         * @return this
         */
        public MBuilder setTargetClass(String name) {
            MASMFix.this.targetClassName = name;
            return this;
        }
         ...
         * @return this
         */
        public MBuilder setTargetMethod(String name) {
            MASMFix.this.targetMethodName = name;
            return this;
        }
         ...
         * @return this
         */
        public MBuilder addTargetMethodParameters(Type... argumentTypes) {
            for (Type type : argumentTypes) {
                MASMFix.this.targetMethodArguments.add(type);
            }
            return this;
        }
         ...
         * @return this
         */
        public MBuilder addTargetMethodParameters(String... argumentTypeNames) {
         ...
         * @return this
         */
        public MBuilder setTargetMethodReturnType(Type returnType) {
            MASMFix.this.targetMethodReturnType = returnType;
            return this;
        }
         ...
         * @return this
         */
        public MBuilder setTargetMethodReturnType(String returnType) {
            return setTargetMethodReturnType(TypeUtils.getType(returnType));
        }

        public MBuilder setLocalVarID(int varId) {
            MASMFix.this.localVarID = varId;
            return this;
        }
         ...
         * @return this
         */
        public MBuilder setFixesClass(String name) {
            MASMFix.this.classWithFixes = name;
            return this;
        }
         ...
         * @return this
         */
        public MBuilder setFixMethod(String name) {
            MASMFix.this.fixMethodName = name;
            return this;
        }
         ...
         * @return this
         */
        public MBuilder addFixMethodParameter(Type parameterType, int variableIndex) {
            if (!MASMFix.this.hasFixMethod()) {
                throw new IllegalStateException("MFix method is not specified, can't append argument to its arguments list.");
            }
            MASMFix.this.fixMethodArguments.add(parameterType);
            MASMFix.this.transmittableVariableIndexes.add(variableIndex);
            return this;
        }
         ...
         * @return this
         */
        public MBuilder addFixMethodParameter(String parameterTypeName, int variableIndex) {
         ...
         * @return this
         */
        public MBuilder addThisToFixMethodParameters() {
            if (!MASMFix.this.hasFixMethod()) {
                throw new IllegalStateException("MFix method is not specified, can't append argument to its arguments list.");
            }
            MASMFix.this.fixMethodArguments.add(TypeUtils.getType(MASMFix.this.targetClassName));
            MASMFix.this.transmittableVariableIndexes.add(0);
            return this;
        }
         ...
         * @return this
         */
        public MBuilder addReturnedValueToFixMethodParameters() {
            if (!MASMFix.this.hasFixMethod()) {
                throw new IllegalStateException("MFix method is not specified, can't append argument to its arguments list.");
            }
            if (MASMFix.this.targetMethodReturnType == Type.VOID_TYPE) {
            ...
            MASMFix.this.fixMethodArguments.add(MASMFix.this.targetMethodReturnType);
            MASMFix.this.transmittableVariableIndexes.add(-1);
            MASMFix.this.hasReturnedValueParameter = true;
            return this;
        }
         ...
         * @return this
         */
        public MBuilder setReturnSetting(EnumReturnSetting setting) {
            if (setting.conditionRequiredToReturn && MASMFix.this.fixMethodName == null) {
                throw new IllegalArgumentException("MFix method isn't specified, can't use a return condition that depends on it.");
            }

            MASMFix.this.EnumReturnSetting = setting;
            Type returnType;
            switch (setting) {
                case NEVER:
                case ALWAYS:
            ...
            MASMFix.this.fixMethodReturnType = returnType;
            return this;
        }
         ...
         * @return this
         */
        public MBuilder setReturnType(EnumReturnType type) {
        	classWithFixes = MASMFix.this.classWithFixes;
        	fixMethodName = MASMFix.this.fixMethodName;
            if (MASMFix.this.EnumReturnSetting == EnumReturnSetting.NEVER) {
                throw new IllegalStateException("Current return condition is never, so it does not make sense to specify the return value.");
            }
            Type returnType = MASMFix.this.targetMethodReturnType;
            ...
            if (type == EnumReturnType.FIX_METHOD_RETURN_VALUE && !hasFixMethod()) {
                throw new IllegalArgumentException("MFix method is not specified, can't use it's return value.");
            }

            MASMFix.this.EnumReturnType = type;
            if (type == EnumReturnType.FIX_METHOD_RETURN_VALUE) { // If the return type is the type of the fix method, we set the return type of the fix method to one of the target method.
                MASMFix.this.fixMethodReturnType = MASMFix.this.targetMethodReturnType; // That is because the type must fit to be returned from the target method.
            }
            return this;
        }
        ...
        public void setFixMethodReturnType(Type type) {
            MASMFix.this.fixMethodReturnType = type;
        }
         ...
         * @return this
         */
        public MBuilder setPrimitiveAlwaysReturned(Object object) {
            if (MASMFix.this.EnumReturnType != EnumReturnType.PRIMITIVE_CONSTANT) {
            ...
            MASMFix.this.primitiveAlwaysReturned = object;
            return this;
        }
         ...
         * @return this
         */
        public MBuilder setReturnMethod(String name) {
            if (MASMFix.this.EnumReturnType != EnumReturnType.ANOTHER_METHOD_RETURN_VALUE) {
            ...
            MASMFix.this.returnMethodName = name;
            return this;
        }

        /**
         * Sets the factory that will specify the inserter type.
         * In other words, specifies, if the fix will be inserted at the start (MASMFix.ON_ENTER_FACTORY) or end (ON_EXIT_FACTORY) of a method. If you need OnLine, create your own factory.
         *
         * @param factory Factory, creating the inserter for this fix
         * @return this
         */
        public MBuilder setInjectorFactory(MFixInserterFactory factory) {
            MASMFix.this.injectorFactory = factory;
            return this;
        }
         ...
         * @return this
         */
        public MBuilder setPriority(FixOrder priority) {
            MASMFix.this.priority = priority;
            return this;
        }
         ...
         * @return this
         * */
        public MBuilder setCreateMethod(boolean createMethod) {
            MASMFix.this.createMethod = createMethod;
            return this;
        }
         ...
         * @return this
         */
        public MBuilder setFatal(boolean isMandatory) {
            MASMFix.this.isFatal = isMandatory;
            return this;
        }
        ...
        /**
         * Creates an MASMFix from the specified parameters.
         *
         * @return The MASMFix.
         * @throws IllegalStateException If one or more of the necessary methods hasn't been called.
         */
        public MASMFix build() {
            MASMFix fix = MASMFix.this;
            ...
            try {
                fix = (MASMFix) MASMFix.this.clone(); // We turn this MASMFix builder into an MASMFix.
            ...
            if (fix.targetMethodName.equals("<init>") && fix.EnumReturnSetting!=EnumReturnSetting.NEVER) {
                MTargetClassTransformer.logger.warning("Return from a constructor before final fields are initialized is detected! This is not recommended." +
                        "Do not set the target method as <init> with InsertionPoint.HEAD without EnumReturnSetting.NEVER.");
            }
            ...
            if (!isReturnFix(fix) && fix.hasReturnedValueParameter) {
        ...
        private boolean isReturnFix(MASMFix fix) {
            return (fix.injectorFactory instanceof OnExit) ||
                    ((fix.injectorFactory instanceof MFixInserterFactory.ByAnchor) && fix.getAnchorPoint()==InsertionPoint.RETURN);
        }
    }
}
