...
public class BuiltinFixes {
	...
	/**
     * Built-in fix to register MCustomClassTransformer after forge's deobfuscation
    ...
    public static void injectData(Loader loader, Object... data) {
        ...
        if (classLoader instanceof LaunchClassLoader) {
            ((LaunchClassLoader)classLoader).registerTransformer(MCustomClassTransformer.class.getName());
        } else {
