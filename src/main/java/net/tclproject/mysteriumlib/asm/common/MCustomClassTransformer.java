 ...
 * */
public class MCustomClassTransformer extends MTargetClassTransformer implements IClassTransformer {
	
	/**An instance of itself that gets created every time the cunstructor gets called.*/
	public static MCustomClassTransformer instance;
    ...
    public MCustomClassTransformer() {
        instance = this;
