...
import net.tclproject.mysteriumlib.render.gecko.common.entities.client.renderer.model.RobotModel;
...
public class RobotRenderer extends RenderLiving
{
	...
	{
		return new ResourceLocation("arsmagica2" + ":textures/model/entity/robot.png");
	}
}