...
import net.tclproject.mysteriumlib.render.gecko.common.entities.entity.specific.BrownEntity;
...
public class BrownModel extends AnimatedEntityModel<BrownEntity>
{
	...
	{
		return new ResourceLocation("arsmagica2", "animations/brown.json");
	}
}