...
public class HorseModel extends ModelBase {
   ...
   public HorseModel() {
      ...
      this.Block1.addBox(-2.0F, -2.0F, -1.5F, 4, 4, 3);
      this.Block1.setRotationPoint(0.0F, 6.0F, 16.0F);
      this.Block2 = new ModelRenderer(this, 46, 13);
      this.Block2.setTextureSize(256, 128);
      this.Block2.addBox(-1.0F, -2.0F, -3.0F, 2, 4, 6);
      this.Block2.setRotationPoint(0.0F, 4.5F, 12.0F);
      this.Reins1 = new ModelRenderer(this, 128, 2);
      this.Reins1.setTextureSize(256, 128);
      this.Reins1.addBox(-5.5F, -5.0F, -6.5F, 11, 10, 13);
      this.Reins1.setRotationPoint(4.842877E-8F, -11.691351F, -6.75F);
      this.SaddleBase = new ModelRenderer(this, 0, 82);
      this.SaddleBase.setTextureSize(256, 128);
      this.SaddleBase.addBox(-7.5F, -0.5F, -10.0F, 15, 1, 20);
      this.SaddleBase.setRotationPoint(0.0F, -10.0F, 8.0F);
      this.SaddleBase2 = new ModelRenderer(this, 0, 82);
      this.SaddleBase2.setTextureSize(256, 128);
      this.SaddleBase2.addBox(-0.5F, -0.5F, -10.0F, 1, 7, 20);
      this.SaddleBase2.setRotationPoint(7.0F, -9.0F, 8.0F);
      this.SaddleBase3 = new ModelRenderer(this, 0, 82);
      this.SaddleBase3.setTextureSize(256, 128);
      this.SaddleBase3.addBox(-0.5F, -0.5F, -10.0F, 1, 7, 20);
      this.SaddleBase3.setRotationPoint(-7.0F, -9.0F, 8.0F);
      this.Saddle = new ModelRenderer(this, 0, 114);
      this.Saddle.setTextureSize(256, 128);
      this.Saddle.addBox(-8.0F, -0.5F, -6.5F, 16, 1, 13);
      this.Saddle.setRotationPoint(0.0F, -11.0F, 6.0F);
      this.Saddle2 = new ModelRenderer(this, 12, 123);
      this.Saddle2.setTextureSize(256, 128);
      this.Saddle2.addBox(-6.5F, -1.0F, -1.0F, 13, 2, 2);
      this.Saddle2.setRotationPoint(0.0F, -11.5F, 13.5F);
      this.Saddle3 = new ModelRenderer(this, 4, 113);
      this.Saddle3.setTextureSize(256, 128);
      this.Saddle3.addBox(-0.5F, -0.5F, -4.5F, 1, 5, 9);
      this.Saddle3.setRotationPoint(7.5F, -10.5F, 6.0F);
      this.Saddle4 = new ModelRenderer(this, 20, 119);
      this.Saddle4.setTextureSize(256, 128);
      this.Saddle4.addBox(-0.5F, -1.0F, -3.0F, 1, 2, 6);
      this.Saddle4.setRotationPoint(8.923505F, -5.187408F, 6.0F);
      this.Saddle5 = new ModelRenderer(this, 17, 113);
      this.Saddle5.setTextureSize(256, 128);
      this.Saddle5.addBox(-0.5F, -0.5F, -4.5F, 1, 5, 9);
      this.Saddle5.setRotationPoint(-7.5F, -10.5F, 6.0F);
      this.Saddle6 = new ModelRenderer(this, 23, 118);
      this.Saddle6.setTextureSize(256, 128);
      this.Saddle6.addBox(-0.5F, -1.0F, -3.0F, 1, 2, 6);
      this.Saddle6.setRotationPoint(-8.923504F, -5.187408F, 6.0F);
      this.Footstrap = new ModelRenderer(this, 11, 120);
      this.Footstrap.setTextureSize(256, 128);
      this.Footstrap.addBox(-0.5F, 0.0F, -1.0F, 1, 6, 2);
      this.Footstrap.setRotationPoint(8.0F, -6.5F, 6.0F);
      this.foot1 = new ModelRenderer(this, 2, 89);
      this.foot1.setTextureSize(256, 128);
      this.foot1.addBox(-0.5F, -0.5F, -2.0F, 1, 1, 4);
      this.foot1.setRotationPoint(9.682323F, -0.2214813F, 6.0F);
      this.foot2 = new ModelRenderer(this, 2, 89);
      this.foot2.setTextureSize(256, 128);
      this.foot2.addBox(-0.5F, -0.5F, -2.0F, 1, 1, 4);
      this.foot2.setRotationPoint(9.682324F, 2.778519F, 6.0F);
      this.foot3 = new ModelRenderer(this, 5, 92);
      this.foot3.setTextureSize(256, 128);
      this.foot3.addBox(-0.5F, -1.0F, -0.5F, 1, 2, 1);
      ...
      this.foot4.addBox(-0.5F, -1.0F, -0.5F, 1, 2, 1);
      ...
      this.Footstrap2.addBox(-0.5F, 0.0F, -1.0F, 1, 6, 2);
      this.Footstrap2.setRotationPoint(-8.0F, -6.5F, 6.0F);
      this.foot1a = new ModelRenderer(this, 2, 89);
      this.foot1a.setTextureSize(256, 128);
      this.foot1a.addBox(-0.5F, -0.5F, -2.0F, 1, 1, 4);
      this.foot1a.setRotationPoint(-9.682323F, -0.2214813F, 6.0F);
      this.foot2a = new ModelRenderer(this, 2, 89);
      this.foot2a.setTextureSize(256, 128);
      this.foot2a.addBox(-0.5F, -0.5F, -2.0F, 1, 1, 4);
      this.foot2a.setRotationPoint(-9.682323F, 2.778519F, 6.0F);
      this.foot3a = new ModelRenderer(this, 5, 92);
      this.foot3a.setTextureSize(256, 128);
      this.foot3a.addBox(-0.5F, -1.0F, -0.5F, 1, 2, 1);
      ...
      this.foot4a.addBox(-0.5F, -1.0F, -0.5F, 1, 2, 1);
   ...
   public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      EntityHorse eh = (EntityHorse)entityIn;
   ...
   public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity scale) {
      this.HeadNode.rotateAngleX = par5 / 57.295776F;
      this.HeadNode.rotateAngleY = par4 / 57.295776F;
      this.HeadNode.rotateAngleX = this.headRotationAngleX;
      this.BackLeftMuscle.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.0F * par2;
      this.BackRightMuscle.rotateAngleX = MathHelper.cos(par1 * 0.6662F + 3.1415927F) * 1.0F * par2;
      this.FrontLeftMuscle.rotateAngleX = MathHelper.cos(par1 * 0.6662F + 3.1415927F) * 1.0F * par2;
