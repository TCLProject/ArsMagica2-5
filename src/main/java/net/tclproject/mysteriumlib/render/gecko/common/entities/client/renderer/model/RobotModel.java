...
import net.tclproject.mysteriumlib.render.gecko.common.entities.entity.specific.RobotEntity;
...
public class RobotModel extends AnimatedEntityModel<RobotEntity> {
	...
	{
		return new ResourceLocation("arsmagica2", "animations/robot.json");
	}
}