...
import net.tclproject.mysteriumlib.render.gecko.common.entities.entity.specific.StingrayTestEntity;
...
public class StingrayModel extends AnimatedEntityModel<StingrayTestEntity>
{
	...
	{
		return new ResourceLocation("arsmagica2:animations/stingrayanimation.json");
	}
