...
public class ChickenModel extends ModelBase {
   ...
   public ChickenModel(float par1) {
      this.RootNode = new ModelRenderer(this, 16, 16);
      this.RootNode.setTextureSize(64, 32);
      this.RootNode.addBox(0.0F, 0.0F, 0.0F, 0, 0, 0);
      this.RootNode.setRotationPoint(0.0F, 15.0F, 0.0F);
      this.Body1 = new ModelRenderer(this, 0, 7);
      this.Body1.setTextureSize(64, 32);
      this.Body1.addBox(-3.0F, -3.0F, -3.0F, 6, 6, 6);
      this.Body1.setRotationPoint(0.0F, 17.99997F, 2.0F);
      this.Wing1 = new ModelRenderer(this, 30, 6);
      this.Wing1.setTextureSize(64, 32);
      this.Wing1.addBox(-0.5F, -1.5F, 0.0F, 1, 3, 4);
      this.Wing1.setRotationPoint(-3.5F, 16.8998F, -1.360003F);
      this.Tail1 = new ModelRenderer(this, 36, 20);
      this.Tail1.setTextureSize(64, 32);
      this.Tail1.addBox(-2.5F, -2.0F, -2.0F, 5, 4, 4);
      this.Tail1.setRotationPoint(0.0F, 18.02851F, 5.041247F);
      this.Tail2 = new ModelRenderer(this, 38, 14);
      this.Tail2.setTextureSize(64, 32);
      this.Tail2.addBox(-2.0F, -1.0F, -1.5F, 4, 2, 3);
      this.Tail2.setRotationPoint(0.0F, -1.264F, 2.28313F);
      this.Wing2 = new ModelRenderer(this, 41, 6);
      this.Wing2.setTextureSize(64, 32);
      this.Wing2.addBox(-0.5F, -1.5F, 0.0F, 1, 3, 4);
      ...
      this.leg2Pivot.addBox(0.0F, 0.0F, 0.0F, 0, 0, 0);
      this.leg2Pivot.setRotationPoint(1.5F, 20.0F, 1.75F);
      this.leg2Top = new ModelRenderer(this, 39, 0);
      this.leg2Top.setTextureSize(64, 32);
      this.leg2Top.addBox(-1.0F, -1.0F, -1.0F, 2, 2, 2);
      this.leg2Top.setRotationPoint(0.0F, 1.29997F, 0.0F);
      this.leg2 = new ModelRenderer(this, 35, 0);
      this.leg2.setTextureSize(64, 32);
      this.leg2.addBox(-0.5F, -2.0F, -0.5F, 1, 2, 1);
      this.leg2.setRotationPoint(0.0F, 4.09997F, -0.7499F);
      this.Foot2 = new ModelRenderer(this, 25, 0);
      this.Foot2.setTextureSize(64, 32);
      this.Foot2.addBox(-0.2F, -0.2F, -1.5F, 1, 1, 3);
      this.Foot2.setRotationPoint(-1.0F, 3.09997F, -1.7500004F);
      this.Foot2b = new ModelRenderer(this, 25, 0);
      this.Foot2b.setTextureSize(64, 32);
      this.Foot2b.addBox(-0.2F, -0.2F, -1.5F, 1, 1, 3);
      this.Foot2b.setRotationPoint(1.0F, 3.09997F, -1.7500001F);
      this.leg1Pivot = new ModelRenderer(this, 41, 2);
      this.leg1Pivot.setTextureSize(64, 32);
      this.leg1Pivot.addBox(0.0F, 0.0F, 0.0F, 0, 0, 0);
      this.leg1Pivot.setRotationPoint(-1.5F, 20.0F, 1.75F);
      this.leg1Top = new ModelRenderer(this, 39, 0);
      this.leg1Top.setTextureSize(64, 32);
      this.leg1Top.addBox(-1.0F, -1.0F, -1.0F, 2, 2, 2);
      this.leg1Top.setRotationPoint(0.0F, 1.29997F, 0.0F);
      this.leg1 = new ModelRenderer(this, 35, 0);
      this.leg1.setTextureSize(64, 32);
      this.leg1.addBox(-0.5F, -2.0F, -0.5F, 1, 2, 1);
      this.leg1.setRotationPoint(0.0F, 4.09997F, -0.7499F);
      this.Foot1 = new ModelRenderer(this, 25, 0);
      this.Foot1.setTextureSize(64, 32);
      this.Foot1.addBox(-0.2F, -0.2F, -1.5F, 1, 1, 3);
      this.Foot1.setRotationPoint(-1.0F, 3.09997F, -1.7500001F);
      this.Foot1b = new ModelRenderer(this, 25, 0);
      this.Foot1b.setTextureSize(64, 32);
      this.Foot1b.addBox(-0.2F, -0.2F, -1.5F, 1, 1, 3);
      this.Foot1b.setRotationPoint(1.0F, 3.09997F, -1.7499999F);
      this.Neck = new ModelRenderer(this, 3, 19);
      this.Neck.setTextureSize(64, 32);
      this.Neck.addBox(-2.5F, -2.5F, -2.0F, 5, 5, 4);
      this.Neck.setRotationPoint(0.0F, 16.8998F, -1.0F);
      this.Neck2 = new ModelRenderer(this, 21, 21);
      this.Neck2.setTextureSize(64, 32);
      this.Neck2.addBox(-2.0F, -2.0F, -1.5F, 4, 4, 3);
      this.Neck2.setRotationPoint(0.0F, -0.7998F, -1.556894F);
      this.Head = new ModelRenderer(this, 0, 0);
      this.Head.setTextureSize(64, 32);
      this.Head.addBox(-1.5F, -2.0F, -1.5F, 3, 4, 3);
      this.Head.setRotationPoint(0.0F, -3.89F, -2.889997F);
      this.Crest = new ModelRenderer(this, 20, 4);
      this.Crest.setTextureSize(64, 32);
      this.Crest.addBox(0.0F, -1.5F, -1.5F, 0, 3, 3);
      this.Crest.setRotationPoint(0.0F, -5.299F, -4.139997F);
      this.CrestBottom = new ModelRenderer(this, 22, 6);
      this.CrestBottom.setTextureSize(64, 32);
      this.CrestBottom.addBox(0.0F, -1.0F, -0.5F, 0, 2, 1);
      this.CrestBottom.setRotationPoint(0.0F, -2.148F, -4.739997F);
      this.BeakBottom = new ModelRenderer(this, 19, 0);
      this.BeakBottom.setTextureSize(64, 32);
      this.BeakBottom.addBox(-0.5F, -0.5F, -1.0F, 1, 1, 2);
      this.BeakBottom.setRotationPoint(0.0F, -3.1499F, -4.889997F);
      this.BeakTop = new ModelRenderer(this, 19, 0);
      this.BeakTop.setTextureSize(64, 32);
      this.BeakTop.addBox(-0.5F, -0.5F, -1.0F, 1, 1, 2);
      this.BeakTop.setRotationPoint(0.0F, -3.4499F, -4.789997F);
   ...
   public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
      ...
      this.Foot2.rotateAngleX = -1.555994E-8F;
      this.Foot2b.rotateAngleX = -4.214685E-8F;
      this.leg1Top.rotateAngleX = 0.2617994F;
      this.leg1.rotateAngleX = -0.2617995F;
      this.Foot1.rotateAngleX = -1.555994E-8F;
      this.Foot1b.rotateAngleX = -4.214685E-8F;
      this.Neck.rotateAngleX = -0.4742105F;
      this.Neck2.rotateAngleX = -0.7360098F;
      this.Head.rotateAngleX = 0.05872217F;
      this.Crest.rotateAngleX = 0.3490659F;
      this.CrestBottom.rotateAngleX = 5.213158E-8F;
      this.BeakBottom.rotateAngleX = 0.05872219F;
      this.BeakTop.rotateAngleX = 0.3169494F;
      this.Neck.rotateAngleX = Math.abs(headPitch / 57.295776F * 1.4F * limbSwingAmount);
      this.Neck.rotateAngleX = Math.abs(netHeadYaw / 57.295776F);
      this.Body1.rotateAngleX = 1.5707964F;
      this.leg1Pivot.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
      this.leg2Pivot.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + 3.1415927F) * 1.4F * limbSwingAmount;
