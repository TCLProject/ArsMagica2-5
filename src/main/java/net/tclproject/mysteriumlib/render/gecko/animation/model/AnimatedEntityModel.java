...
package net.tclproject.mysteriumlib.render.gecko.animation.model;
...
import net.tclproject.mysteriumlib.render.gecko.animation.keyframe.AnimationPoint;
import net.tclproject.mysteriumlib.render.gecko.animation.keyframe.BoneAnimationQueue;
...
import net.tclproject.mysteriumlib.render.gecko.animation.snapshot.DirtyTracker;
import net.tclproject.mysteriumlib.render.gecko.animation.snapshot.EntityDirtyTracker;
...
import net.tclproject.mysteriumlib.render.gecko.util.json.JsonAnimationUtils;
...
public abstract class AnimatedEntityModel<T extends EntityLivingBase & IAnimatedEntity> extends ModelBase implements IResourceManagerReloadListener
{
	...
	/**
	 * This resource location needs to point to a json file of your animation file, i.e. "arsmagica2:animations/frog_animation.json"
	 *
