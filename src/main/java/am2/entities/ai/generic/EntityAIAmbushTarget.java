...
public class EntityAIAmbushTarget extends EntityAIBase
{
    ...
    public EntityAIAmbushTarget(EntityGeneric par1EntityCreature, double par2, double par3, boolean par4)
    {
    ...
    public boolean continueExecuting()
    {
    	...
    	return (!this.theEntity.getNavigator().noPath() && shouldHide) || (!isSeen && (shouldHide || !this.theEntity.seesIndirect));
    }
