...
public class EntityAIClosestTarget extends EntityAITarget
{
    ...
    public boolean shouldExecute()
    {
        ...
        {
            taskOwner.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(Double.valueOf(((EntityGeneric)taskOwner).getValue("aggR")));
            ...
            taskOwner.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(Double.valueOf(((EntityGeneric)taskOwner).getValue("navR")));
            if (list.isEmpty())
            {
                return false;
            }
