...
package am2.worldgen.smartgen.schematics;

import am2.AMCore;
import am2.worldgen.smartgen.reccomplexutils.RCAccessorNBT;
...
//        return schematicsFile != null ? FileUtils.listFiles(schematicsFile, new String[]{"schematic"}, true) : Collections.<File>emptyList();
    ...
    // no publicly loaded schematics, this isn't rccomplex
    public static File getValidatedSchematicsFile()
    {
//        File structuresFile = IvFileHelper.getValidatedFolder(AMCore.proxy.getBaseFolderFile("structures"));
