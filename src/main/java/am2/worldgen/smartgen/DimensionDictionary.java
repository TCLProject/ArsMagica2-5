 ...
 *
 * If you want to handle the types yourself, implement {@link DimensionDictionary.Handler} in your WorldProvider.
 */
public class DimensionDictionary
{
    ...
    static
    {
        ...
        registerDimensionTypes(AMCore.config.getMMFDimensionID(), Arrays.asList(REAL, INFINITE, NO_TOP_LIMIT, BOTTOM_LIMIT, PLANET_SURFACE, HELL));
    }
