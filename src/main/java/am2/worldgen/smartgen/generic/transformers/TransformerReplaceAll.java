...
public class TransformerReplaceAll extends TransformerSingleBlock<TransformerReplaceAll.InstanceData>
{
    ...
    {
        this(BlockMatcher.of(AMCore.specialRegistry, Blocks.wool, new IntegerRange(0, 15)));
...
//    }
    ...
    public static class InstanceData implements NBTStorable
    {
        ...
        {
            this.blockState = new WeightedBlockState(AMCore.specialRegistry, compound.getCompoundTag("blockState"));
        ...
        public NBTBase writeToNBT()
        {
            ...
            compound.setTag("blockState", blockState.writeToNBT(AMCore.specialRegistry));
