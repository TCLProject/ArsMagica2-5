...
//@Mod(modid = "arsmagica2", modLanguage = "java", name = "Ars Magica 2", version = "1.6.8", dependencies = "required-after:AnimationAPI")
@Mod(modid = "arsmagica2", modLanguage = "java", name = "Ars Magica 2", version = "1.6.8", dependencies = "required-after:AnimationAPI;required-after:CoFHCore")
public class AMCore{
